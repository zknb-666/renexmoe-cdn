...
const drawertoggle = () => {
  $("#about_theme").on("click", () => {
    new mdui.alert(
      `<div class="mdui-typo">
      <a href="https://github.com/186526/onemanager-theme-renexmoe">
      Onemanager-theme-renexmoe ${pack.version}</a>
      <br>
       Author:<a href="https://186526.xyz">186526</a>
      <br>
      Modify:<a href="https://zknb-666.ml>备考中</a>
      </div>`,
      "关于renexmoe"
    );
    mdui.mutation();
